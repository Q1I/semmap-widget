		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			try {
				...
				for (FileItem fileItem : items) {
					...
					echo("Type: " + fileItem.getContentType());
				...
				if(msg != null)
					response.sendError(
							...
							"An error occurred while adding template : "+msg);
				...
				try {
					...
					response.getWriter().print("File was added to database!");
